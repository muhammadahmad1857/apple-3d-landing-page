...
const VideoCarousel = () => {
  ...
  const handleLoadedMetaData = ( ) => setLoadedData((pre) => [...pre, true]);
...
//   const isTablet = useMediaQuery({ query: "(min-width: 761px) and (max-width: 1200px)" });
//   const isLaptop = useMediaQuery({ query: "(min-width: 1201px)" });

//   const getProgressBarWidth = (): string => {
//     if (isMobile) return "10vw";
//     if (isTablet) return "10vw";
//     if (isLaptop) return "4vw";
//     return "4vw"; // Default case
//   };
...
//             // Set progress bar width and background color
//             gsap.to(videoDivRef.current[videoId], {
...
//       case "video-reset":
//         setVideo({ isEnd: false, videoId: 0, isLastVideo: false, isPlaying: false, startPlay: false });
//         break;
